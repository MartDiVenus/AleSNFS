...
echo "
Name: Luxdim
Goal: To  print  size  of  a  file, files, sum of files size, in  diverse  units,
in   according  with scientific international notation style. "
echo " "
		echo "Version: backemerg-5.0.0"
...
echo "Sum of files sizes							--i=<Value>"
...
Output is written on stdout and in /tmp/outluxdim.
...
stat --format %s /tmp/luxdimOption > /tmp/luxdimOptionBytes

leggoBytes=$(cat /tmp/luxdimOptionBytes)
