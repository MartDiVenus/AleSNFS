...
#cat /tmp/outluxdim | tail -n1 | cut -d. -f2,2 | sed 's/,/\\033\[32;40;5m\\033\[1m,\\033\[0m/g' > /tmp/outluxdim-dx

#cat /tmp/outluxdim | tail -n1 | cut -d, -f2,2 > /tmp/outluxdim-dx
#dx=$(cat /tmp/outluxdim-dx)
...
echo ""
	...
	cat /tmp/luxdimTargetFile | sed 's/*/specialDirindindin/g' > /tmp/backemerg-fullName
        ...
        /usr/local/lib/backemerg/trattamentoFilesSomma.sh
	...
	# sempre a trattamentoFilesSomma.
