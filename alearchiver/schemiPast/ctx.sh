...
vim -c ":runtime! vimScript/backemerg/alearchiver/ctx/CTX01.vim" -c ":cal CTX01#CTX01()" /tmp/backemergRuffiano -c :q

pathDestination="$(cat /tmp/backemergVimInputCTX01)"
...
" > /usr/local/lib/backemerg/alearchiver/echoLines/ctx/ctx02.txt

vim -c ":runtime! vimScript/backemerg/alearchiver/ctx/CTX02.vim" -c ":cal CTX02#CTX02()" /tmp/backemergRuffiano -c :q

destPathManuale="$(cat /tmp/backemergVimInputCTX02)"
