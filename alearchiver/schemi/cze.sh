...
if [ -f /tmp/alearchiver-cimiceFolderOrFile-cartella ]; then
	...
	zip -e -r $nomeCartella.zip $nomeCartella

	else

	zip -e -r $nomeFileSenzaEstensione.zip $nomeFile
...
if [ -f /tmp/alearchiver-cimiceFolderOrFile-cartella ]; then
	...
	zip -e -r $destPathManuale/$nomeCartella.zip $nomeCartella

	else

	zip -e -r $destPathManuale/$nomeFileSenzaEstensione.zip $nomeFile
